            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span className="text-sm text-gray-600">Expert AI automation consultancy</span>
                </li>
                <li className="flex items-start">
                  <div className="w-2 h-2 bg-primary-500 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                  <span className="text-sm text-gray-600">Tailored solutions for your industry</span>
                </li>
                <li className="flex items-start">
                  <div className="w-2 h-2 bg-primary-500 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                  <span className="text-sm text-gray-600">Proven track record with SMEs</span>
                </li>
                <li className="flex items-start">
                  <div className="w-2 h-2 bg-primary-500 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                  <span className="text-sm text-gray-600">Ongoing support and optimization</span>
                </li>
              </ul>
            </div>
          </motion.div>
